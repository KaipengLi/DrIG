...
# Train split
# ----------------------------
QUERY_DATA_PATH="query/train/mscoco/mbeir_mscoco_task0_train.jsonl"
CAND_POOL_PATH="cand_pool/local/train/mbeir_mscoco_task0_train_cand_pool.jsonl"

# ----------------------------
# Output controls
# ----------------------------
SAVE_DIR="/data/likaipeng/dig/embed/lamra/mscoco/train/"
QUERY_OUT="mbeir_mscoco_train_query_dict.pt"
POOL_OUT="mbeir_mscoco_train_cand_pool_dict.pt"
...
echo "[DONE] mscoco_train embeddings saved to: $SAVE_DIR"